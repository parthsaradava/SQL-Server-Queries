...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '_[AEIOU][AEIOU]%' AND
	  CITY LIKE 'R%'
...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '%[AEIOU]' AND
	  DEPARTMENT LIKE '[AEIOU]%' AND
...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '_[AEIOU]%' AND 
	  LASTNAME LIKE '%R' AND
	  SALARY < 12000
